# Generated by Django 3.2.13 on 2022-11-14 17:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('호두', '호두'), ('조개류', '조개류'), ('해당없음', '해당없음'), ('고등어', '고등어'), ('닭고기', '닭고기'), ('땅콩', '땅콩'), ('게', '게'), ('밀', '밀'), ('토마토', '토마토'), ('아황산류', '아황산류'), ('쇠고기', '쇠고기'), ('메밀', '메밀'), ('복숭아', '복숭아'), ('돼지고기', '돼지고기'), ('난류', '난류'), ('새우', '새우'), ('오징어', '오징어'), ('우유', '우유'), ('대두', '대두')], max_length=67)),
