# Generated by Django 3.2.13 on 2022-11-18 19:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('토마토', '토마토'), ('밀', '밀'), ('난류', '난류'), ('조개류', '조개류'), ('아황산류', '아황산류'), ('새우', '새우'), ('오징어', '오징어'), ('복숭아', '복숭아'), ('메밀', '메밀'), ('호두', '호두'), ('닭고기', '닭고기'), ('우유', '우유'), ('쇠고기', '쇠고기'), ('땅콩', '땅콩'), ('돼지고기', '돼지고기'), ('대두', '대두'), ('게', '게'), ('해당없음', '해당없음'), ('고등어', '고등어')], max_length=67)),
