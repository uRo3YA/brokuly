    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('복숭아', '복숭아'), ('밀', '밀'), ('우유', '우유'), ('대두', '대두'), ('새우', '새우'), ('해당없음', '해당없음'), ('닭고기', '닭고기'), ('땅콩', '땅콩'), ('토마토', '토마토'), ('오징어', '오징어'), ('게', '게'), ('호두', '호두'), ('쇠고기', '쇠고기'), ('고등어', '고등어'), ('조개류', '조개류'), ('난류', '난류'), ('아황산류', '아황산류'), ('돼지고기', '돼지고기'), ('메밀', '메밀')], max_length=67)),
