# Generated by Django 3.2.13 on 2022-11-17 01:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('호두', '호두'), ('닭고기', '닭고기'), ('복숭아', '복숭아'), ('메밀', '메밀'), ('조개류', '조개류'), ('돼지고기', '돼지고기'), ('쇠고기', '쇠고기'), ('우유', '우유'), ('난류', '난류'), ('땅콩', '땅콩'), ('대두', '대두'), ('오징어', '오징어'), ('새우', '새우'), ('토마토', '토마토'), ('아황산류', '아황산류'), ('해당없음', '해당없음'), ('게', '게'), ('고등어', '고등어'), ('밀', '밀')], max_length=67)),
