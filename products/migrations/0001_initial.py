# Generated by Django 3.2.13 on 2022-11-13 23:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('호두', '호두'), ('오징어', '오징어'), ('게', '게'), ('닭고기', '닭고기'), ('우유', '우유'), ('쇠고기', '쇠고기'), ('난류', '난류'), ('조개류', '조개류'), ('메밀', '메밀'), ('아황산류', '아황산류'), ('돼지고기', '돼지고기'), ('대두', '대두'), ('새우', '새우'), ('고등어', '고등어'), ('땅콩', '땅콩'), ('토마토', '토마토'), ('복숭아', '복숭아'), ('밀', '밀')], max_length=62)),
