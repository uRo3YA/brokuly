# Generated by Django 3.2.13 on 2022-11-17 04:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('닭고기', '닭고기'), ('고등어', '고등어'), ('아황산류', '아황산류'), ('밀', '밀'), ('돼지고기', '돼지고기'), ('복숭아', '복숭아'), ('게', '게'), ('새우', '새우'), ('토마토', '토마토'), ('조개류', '조개류'), ('해당없음', '해당없음'), ('쇠고기', '쇠고기'), ('호두', '호두'), ('대두', '대두'), ('메밀', '메밀'), ('오징어', '오징어'), ('우유', '우유'), ('난류', '난류'), ('땅콩', '땅콩')], max_length=67)),
