# Generated by Django 3.2.13 on 2022-11-15 00:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('고등어', '고등어'), ('우유', '우유'), ('해당없음', '해당없음'), ('닭고기', '닭고기'), ('아황산류', '아황산류'), ('메밀', '메밀'), ('대두', '대두'), ('게', '게'), ('쇠고기', '쇠고기'), ('오징어', '오징어'), ('복숭아', '복숭아'), ('밀', '밀'), ('조개류', '조개류'), ('돼지고기', '돼지고기'), ('난류', '난류'), ('새우', '새우'), ('호두', '호두'), ('땅콩', '땅콩'), ('토마토', '토마토')], max_length=67)),
