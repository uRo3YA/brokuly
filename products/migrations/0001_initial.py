# Generated by Django 3.2.13 on 2022-11-17 10:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('닭고기', '닭고기'), ('난류', '난류'), ('돼지고기', '돼지고기'), ('대두', '대두'), ('밀', '밀'), ('조개류', '조개류'), ('아황산류', '아황산류'), ('우유', '우유'), ('복숭아', '복숭아'), ('새우', '새우'), ('쇠고기', '쇠고기'), ('호두', '호두'), ('고등어', '고등어'), ('게', '게'), ('오징어', '오징어'), ('해당없음', '해당없음'), ('토마토', '토마토'), ('메밀', '메밀'), ('땅콩', '땅콩')], max_length=67)),
