# Generated by Django 3.2.13 on 2022-11-15 17:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('닭고기', '닭고기'), ('조개류', '조개류'), ('메밀', '메밀'), ('호두', '호두'), ('밀', '밀'), ('복숭아', '복숭아'), ('난류', '난류'), ('돼지고기', '돼지고기'), ('대두', '대두'), ('오징어', '오징어'), ('땅콩', '땅콩'), ('우유', '우유'), ('토마토', '토마토'), ('새우', '새우'), ('아황산류', '아황산류'), ('해당없음', '해당없음'), ('쇠고기', '쇠고기'), ('고등어', '고등어'), ('게', '게')], max_length=67)),
