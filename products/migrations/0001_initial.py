    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('우유', '우유'), ('복숭아', '복숭아'), ('해당없음', '해당없음'), ('아황산류', '아황산류'), ('호두', '호두'), ('난류', '난류'), ('게', '게'), ('토마토', '토마토'), ('닭고기', '닭고기'), ('돼지고기', '돼지고기'), ('대두', '대두'), ('오징어', '오징어'), ('고등어', '고등어'), ('메밀', '메밀'), ('땅콩', '땅콩'), ('쇠고기', '쇠고기'), ('밀', '밀'), ('조개류', '조개류'), ('새우', '새우')], max_length=67)),
