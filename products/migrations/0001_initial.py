# Generated by Django 3.2.13 on 2022-11-17 14:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('우유', '우유'), ('호두', '호두'), ('쇠고기', '쇠고기'), ('메밀', '메밀'), ('해당없음', '해당없음'), ('오징어', '오징어'), ('토마토', '토마토'), ('난류', '난류'), ('밀', '밀'), ('조개류', '조개류'), ('게', '게'), ('대두', '대두'), ('새우', '새우'), ('돼지고기', '돼지고기'), ('고등어', '고등어'), ('아황산류', '아황산류'), ('닭고기', '닭고기'), ('땅콩', '땅콩'), ('복숭아', '복숭아')], max_length=67)),
