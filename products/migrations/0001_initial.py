# Generated by Django 3.2.13 on 2022-11-13 15:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('우유', '우유'), ('메밀', '메밀'), ('조개류', '조개류'), ('돼지고기', '돼지고기'), ('난류', '난류'), ('게', '게'), ('호두', '호두'), ('복숭아', '복숭아'), ('아황산류', '아황산류'), ('토마토', '토마토'), ('밀', '밀'), ('고등어', '고등어'), ('쇠고기', '쇠고기'), ('닭고기', '닭고기'), ('새우', '새우'), ('오징어', '오징어'), ('땅콩', '땅콩'), ('대두', '대두')], max_length=62)),
