# Generated by Django 3.2.13 on 2022-11-17 01:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('새우', '새우'), ('닭고기', '닭고기'), ('복숭아', '복숭아'), ('토마토', '토마토'), ('조개류', '조개류'), ('해당없음', '해당없음'), ('우유', '우유'), ('땅콩', '땅콩'), ('호두', '호두'), ('난류', '난류'), ('메밀', '메밀'), ('아황산류', '아황산류'), ('쇠고기', '쇠고기'), ('고등어', '고등어'), ('대두', '대두'), ('돼지고기', '돼지고기'), ('게', '게'), ('밀', '밀'), ('오징어', '오징어')], max_length=67)),
