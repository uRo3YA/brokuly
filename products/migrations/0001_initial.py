# Generated by Django 3.2.13 on 2022-11-15 01:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('새우', '새우'), ('돼지고기', '돼지고기'), ('대두', '대두'), ('닭고기', '닭고기'), ('메밀', '메밀'), ('해당없음', '해당없음'), ('우유', '우유'), ('아황산류', '아황산류'), ('쇠고기', '쇠고기'), ('오징어', '오징어'), ('호두', '호두'), ('토마토', '토마토'), ('땅콩', '땅콩'), ('복숭아', '복숭아'), ('게', '게'), ('밀', '밀'), ('난류', '난류'), ('조개류', '조개류'), ('고등어', '고등어')], max_length=67)),
