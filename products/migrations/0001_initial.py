# Generated by Django 3.2.13 on 2022-11-16 16:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('아황산류', '아황산류'), ('새우', '새우'), ('게', '게'), ('호두', '호두'), ('메밀', '메밀'), ('밀', '밀'), ('고등어', '고등어'), ('쇠고기', '쇠고기'), ('돼지고기', '돼지고기'), ('닭고기', '닭고기'), ('조개류', '조개류'), ('우유', '우유'), ('복숭아', '복숭아'), ('오징어', '오징어'), ('땅콩', '땅콩'), ('토마토', '토마토'), ('대두', '대두'), ('해당없음', '해당없음'), ('난류', '난류')], max_length=67)),
