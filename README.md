...
- 최준우 : 이전 프로젝트에서 하고 싶었던 다양한 API들을 사용해볼 수 있었던 기회였고, 주문, 이메일인증등의 기능흐름을 살펴보고 해당 기능을 구현할 수 있는 다양한 방법들을 찾아 볼 수 있었습니다. 다음 프로젝트에서는 이번 프로젝트의 경험을 바탕으로 DRF등을 활용하여 직접 API서버도 구축해봐야겠다는 생각이 들었습니다. 감사합니다.
