...
def pay(request, pk):
    if request.method == "POST":
        ...
        params = {
            ...
            "approval_url": f"http://brokurly.shop:8000/orders/success/{order.pk}/",
            "cancel_url": f"http://brokurly.shop:8000/orders/cancel/{order.pk}/",
            "fail_url": f"http://brokurly.shop:8000/orders/fail/{order.pk}/",
        }
